...
public:
    ...
    void setupUi(QDialog *BookTicketBox)
    {
        ...
        layoutWidget->setGeometry(QRect(80, 30, 284, 27));
        ...
        StartAirport = new QComboBox(layoutWidget);
        ...
        layoutWidget1 = new QWidget(BookTicketBox);
        layoutWidget1->setObjectName(QString::fromUtf8("layoutWidget1"));
        layoutWidget1->setGeometry(QRect(30, 90, 330, 27));
        ...
        DesAirport = new QComboBox(layoutWidget1);
        ...
        layoutWidget2 = new QWidget(BookTicketBox);
        layoutWidget2->setObjectName(QString::fromUtf8("layoutWidget2"));
        layoutWidget2->setGeometry(QRect(60, 150, 220, 28));
        ...
        Date = new QDateEdit(layoutWidget2);
